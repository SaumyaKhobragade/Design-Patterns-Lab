...
public class DBConnection {
    ...
    /**
     * Loads a value from the .env file in the project directory.
     * Falls back to a real environment variable if .env is absent.
     * Throws clearly if neither source has the key.
     */
    private static String loadSecret(String key) {
        ...
        // Fallback: actual OS environment variable
    ...
    /** Parses a .env file (key=value lines, # comments ignored). */
    private static Map<String, String> loadDotEnv(String path) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(path))) {
            ...
            // .env file not present — will fall back to OS env var
        }
        return map;
    }
